...
public class Bo {
    ...
    public void showBook() {
        ...
        System.out.println("共有" + (book.booknames.length - remainSpace()) + "种药品");
    ...
    // 展示所有信息
    public void showAll() {
        System.out.println("3333bo = ");
        for (int i = 0; i < book.booknames.length; i++) {
            if (book.booknames[i] != null) {
                System.out.println("---------------------------------------编号" + (i + 1)
                        + "--------------------------------------------------------------");
                System.out.println("编号" + (i + 1) );
                System.out.print("药品名：" + book.booknames[i] + " ");
                System.out.print("生产厂商：" + book.authors[i] + " ");
                System.out.print("出厂日期：" + book.pubdates[i] + " ");
                System.out.print("总数：" + book.sumpaginations[i] + " ");
                System.out.println("价格：" + book.borrowreaders[i]);
            }
        }
        System.out.println(
                "---------------------------------------------------------------------------------------------------------");
    ...
    public void showPart(int a) {
        ...
        System.out.println(
                "---------------分界线---------------------------------------------------------------------------------------------------");
        System.out.println("编号" + (i) + "的详细信息为：");
    ...
    public int bookinfo() {
        for (int i = 0; i < book.booknames.length; i++) {
            if (book.booknames[i] != null) {
                System.out.println("编号" + (i + 1) + "：" + book.booknames[i] + " ");
            }
        }
        System.out.print("输入相应编号即可查看相应详细信息(输入0则查看所有信息)：");
